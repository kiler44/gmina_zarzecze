...
/**
 * Klasa obserwatora logujaca raporty zdarzen do pliku w katalogu przeznaczonym na raporty
 *
 * @author Krzysztof Żak, Konrad Rudowski
 * @package biblioteki
 */

class DoPlikuRaport extends Zdarzenia\Obserwator
{
	...
	{
		$katalog = new Katalog(TEMP_KATALOG.'/private/logi/uzupelnienia/', true);
		$this->plikLog = $katalog.'/'.date ("Y-m-d", $_SERVER['REQUEST_TIME']).'-'.$obserwator->obiekt_docelowy.'.log';
	}
