<?php
namespace Generic\Tlumaczenie\No\Modul\RaportyGet;
...
class Admin extends Tlumaczenie
{
	...
	*/
	protected $tlumaczeniaDomyslne = array(
		...
		'gridApartamenty.address' => 'Adresse]',
		'gridApartamenty.akceptacja_get' => 'Checked',
		'gridApartamenty.apartment' => 'H-NR',
		'gridApartamenty.city' => 'Poststed',
		'gridApartamenty.data_zakonczenia' => 'Date stop',
		'gridApartamenty.date_start' => 'Dato',
		'gridApartamenty.druga_tura_apartament' => 'Second round',
		'gridApartamenty.hours_interval' => 'Inst. tid',
		'gridApartamenty.klient' => 'Eier/Medeier - Fremleier',
		'gridApartamenty.podglad' => 'Preview',
		'gridApartamenty.postcode' => 'Postnr',
