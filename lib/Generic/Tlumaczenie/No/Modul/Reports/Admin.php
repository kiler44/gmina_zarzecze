<?php
namespace Generic\Tlumaczenie\No\Modul\Reports;
...
class Admin extends Tlumaczenie
{
	...
	*/
	protected $tlumaczeniaDomyslne = array(
		'delete.blad_nie_mozna_pobrac_obiektu' => 'Rapporter ikke funnet',
		'delete.obiekt_usuniety' => 'Rapporten har blitt slettet',
		'delete.obiekt_usuniety_blad' => 'Du kan ikke slette denne rapporten',
		...
		'formularzSzukaj.kategoria.etykieta' => 'Kategori : ',
		'formularzSzukaj.szukaj.wartosc' => 'Søk',
		'formularzSzukaj.wybierz' => 'Velg',
		'index.etykietaMenu' => 'Rapporter',
		'index.etykieta_autor' => 'Forfatter',
		'index.etykieta_data_do' => 'Dato til',
		'index.etykieta_data_dodania' => 'Dato lagt',
		'index.etykieta_data_od' => 'Dato fra',
		'index.etykieta_kategoria' => 'Kategori',
		'index.etykieta_lista_raportow_niestandardowych' => 'Raporty PDF: Villa, B2B i Digging',
		'index.etykieta_obiekt' => 'Object',
		'index.etykieta_potwierdz_usun' => 'Er du sikker på at du vil slette denne rapporten?',
		'index.etykieta_raportyExcel' => 'Villa excel report',
		'index.etykieta_raportyPdf' => 'Villa, B2B, Digging PDF reports',
		'index.etykieta_wyslany' => 'Sendte',
		'index.etykieta_wyslij_raport' => 'Send en rapport',
		'index.etykieta_zalacznik' => 'Last ned vedlegget',
		'index.raport_zapisany' => 'Rapporten er lagret',
		'index.tabela_etykieta_edytuj' => 'Rediger',
		'index.tabela_etykieta_podglad' => 'Forhåndsvisning',
		'index.tabela_etykieta_revert' => 'Gjenopprett fra søppel',
		'index.tabela_etykieta_usun' => 'Slett',
		'index.tytul_modulu' => 'Rapporter',
		'index.tytul_strony' => 'Rapporter',
		...
		'podgladKlient.etykieta_powrot' => '&laquo; Powrót',
		...
		'raportyPdf.etykieta_lista_raportow' => '[ETYKIETA:raportyPdf.etykieta_lista_raportow]',	//TODO
		'raportyPdf.etykieta_potwierdz_usun' => '[ETYKIETA:raportyPdf.etykieta_potwierdz_usun]',	//TODO
		'raportyPdf.etykieta_wyslij_raport' => '[ETYKIETA:raportyPdf.etykieta_wyslij_raport]',	//TODO
		'raportyPdf.etykieta_zalacznik' => '[ETYKIETA:raportyPdf.etykieta_zalacznik]',	//TODO
		'raportyPdf.tabela_etykieta_edytuj' => '[ETYKIETA:raportyPdf.tabela_etykieta_edytuj]',	//TODO
		'raportyPdf.tabela_etykieta_podglad' => '[ETYKIETA:raportyPdf.tabela_etykieta_podglad]',	//TODO
		'raportyPdf.tabela_etykieta_usun' => '[ETYKIETA:raportyPdf.tabela_etykieta_usun]',	//TODO
		'raportyPdf.tytul_modulu' => '[ETYKIETA:raportyPdf.tytul_modulu]',	//TODO
		'raportyPdf.tytul_strony' => '[ETYKIETA:raportyPdf.tytul_strony]',	//TODO
		'revert.blad_nie_mozna_pobrac_obiektu' => 'Rapporter ikke funnet',
		'revert.obiekt_przywrocona_z_kosza' => 'Rapporten ble tilbake fra søppel',
		'tabelaKlient.etykieta_nazwa' => 'Nazwa',
		'tabelaKlient.etykieta_opis' => 'Opis raportu',
		'trash.etykietaMenu' => 'Søppel',
		...
		'wyslijRaport.brak_raportu' => 'Det finnes ingen rapport',
		'wyslijRaport.raport_nie_wyslany' => 'Mislyktes å sende rapporten',
		'wyslijRaport.raport_wyslany' => 'Rapporten ble sendt',
		'zapiszDzian.bladZapisu' => '[ETYKIETA:zapiszDzian.bladZapisu]',	//TODO
		'zapiszDzien.blad_pobrania_dystansu_trasy' => '[ETYKIETA:zapiszDzien.blad_pobrania_dystansu_trasy]',	//TODO
		'zapiszDzien.blad_zapisu_danych_raportu' => '[ETYKIETA:zapiszDzien.blad_zapisu_danych_raportu]',	//TODO
		'zapiszDzien.etykieta_blad_zapisu_nadgodziny' => '[ETYKIETA:zapiszDzien.etykieta_blad_zapisu_nadgodziny]',	//TODO
		'zapiszNadgodziny.etykieta_blad_zapisu_nadgodziny' => '[ETYKIETA:zapiszNadgodziny.etykieta_blad_zapisu_nadgodziny]',	//TODO
		'zarzadzanie_raportami.etykietaMenu' => 'Zarządzanie raportami',
		...
		'kategorie_raportow' => array(
			'villa instalacje raport faktura' => 'Rapporter faktura skjema Villa installasjon',
			'b2b instalacje raport faktura' => 'Rapporter faktura skjem B2B installasjon',
			'digging report' => 'Rapporter faktura fra GET Graving bestillinger',
		),
		'objekty_raportow' => array(
			'zamowienie' => 'Bestillinger',
		),
	);
