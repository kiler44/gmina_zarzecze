<?php
namespace Generic\Tlumaczenie\No\Modul\EmailZarzadzanie;
...
class Admin extends Tlumaczenie
{
	protected $tlumaczeniaDomyslne = array(
		...
		'formatka.predefiniowani_odbiorcy' => array(
			'{KLIENT}' => 'PRIVAT KUNDE',
			'{KLIENT_WYSLIJ_FAKTURA}' => 'KUNDE SEND FAKTURA',
			'{KLIENT_OSOBA_KONTAKTOWA}' => 'KUNDEKONTAKT PERSON',
			'{KLIENT_FAKTURA}' => 'STATISTIKKODE KUNDE',
			'{KIEROWNIK_PROJEKTU_GET}' => 'PROSJEKTLEDER GET',
			'{KOORDYNATOR_BKT}' => 'KOORDINATOR BKT',
			'{KOORDYNATOR_BKT_STARY}' => 'FORRIGE COORDINATOR BKT',
			'{NADAWCA_WIADOMOSCI}' => 'E-SENDEREN',
			'{ODBIORCA_WIADOMOSCI}' => 'E-MOTTAKER',
			'{TEAM}' => 'LAG',
			'{NEW_TEAM}' => 'NYTT TEAM',
			'{PREVIOUS_TEAM}' => 'FORRIGE TEAM',
			'{UZYTKOWNIK}' => 'BRUKER',
