 ...
 * @property array $t['typy_menu']
 * @property string $t['typy_menu']['biezaca_rodzicem']
 * @property string $t['typy_menu']['gotowe_menu']
 * @property string $t['typy_menu']['wybrana_rodzicem']
 * @property string $t['typy_menu']['biezaca_dzieckiem']
 */
