 ...
 * @property string $t['formularzFiltrDat.dataStart.etykieta']
 * @property string $t['formularzFiltrDat.dataStop.etykieta']
 * @property string $t['formularzFiltrDat.filtruj.wartosc']
...
class Admin extends Tlumaczenie
{
	...
	*/
	protected $tlumaczeniaDomyslne = array(
		'dodajGrupe.blad_zapisu' => 'Error saving data',
		'dodajGrupe.grupa_istnieje' => 'Group name already exists',
		...
		'dodajTeamDoListy.blad_zapisu' => 'Error saving data',
		'dodajTeamDoListy.team_nie_istnieje' => 'Selected Team does not exist',
		'dodajUzytownikaDoEkipy.uzytkownik_nie_istnieje' => 'The worker is not found in the database',
		'dodajWydarzenie.lista_wydarzen_pusta' => 'The list of available events is empty, or do not have permission to any event',
		'edycjaTeamu.date_from_etykieta' => 'Date from : ',
		'edycjaTeamu.date_to_etykieta' => 'Date to :',
		'edycjaTeamu.edcyja_teamu_etykieta' => 'Team {TEAM_NAZWA}',
		'edycjaTeamu.potwierdz_usun_pracownika' => 'Are you sure you want to remove the employee from Team?',
		'edycjaTeamu.set_as_leader_etykieta' => 'Set as leader',
		'edycjaTeamu.set_day_off_etykieta' => 'Set day off',
		'formularzFiltrDat.dataStart.etykieta' => 'Date from',
		'formularzFiltrDat.dataStop.etykieta' => ' to ',
		'formularzFiltrDat.filtruj.wartosc' => 'Show',
		'index.anuluj_etykieta' => 'Cancel',
		'index.bg_etykieta' => 'Bg',
		'index.clear_etykieta' => 'Clear',
		'index.date_etykieta' => 'Date',
		'index.date_from_etykieta' => 'Date from',
		'index.date_range_etykieta' => 'Date range : ',
		'index.date_to_etykieta' => 'Date to',
		'index.edcyja_teamu_etykieta' => 'Edit team',
		'index.filter_etykieta' => 'Filter',
		'index.get_more_etykieta' => 'GET MORE DATE',
		'index.menu_add_comment' => 'Add comment',
		'index.menu_clear_select' => 'Clear select',
		'index.menu_clone_event' => 'Clone events',
		'index.menu_edit_comment' => 'Edit comment',
		'index.menu_move_event' => 'Move events',
		'index.menu_remove_comment' => 'Delete comment',
		'index.menu_remove_selected_event' => 'Remove selected events',
		'index.menu_select_similar_event' => 'Selectr similar events',
		'index.menu_show_comment' => 'Show comment',
		'index.menu_show_day_details' => 'Show day details',
		'index.menu_show_note' => 'Note preview',
		'index.menu_show_order_details' => 'Order preview',
		'index.menu_ustaw_lidera' => 'Set as leader',
		'index.menu_usun_z_grupy' => 'Unpin from group',
		'index.menu_wykonaj_event' => 'Run selected event',
		'index.menu_zaznacz_pracownika' => 'Select user',
		'index.nieZaznaczonoDatyKomunikat' => 'Please first select a date on the calendar.',
		'index.number_of_teams_etykieta' => 'Number of teams',
		'index.potwierdzUsunPrzypisanie' => 'Are you sure you want to delete an event?',
		'index.pusta_lista_wyszukiwania' => 'Search list is empty',
		'index.run_current_events_etykieta' => 'Run current events',
		'index.search_etykieta' => 'Search : ',
		'index.team_filter_etykieta' => 'Filter',
		'index.txt_etykieta' => 'Txt',
		'index.typ_eventu_etykieta' => 'Type : ',
		'index.tytul_modulu' => 'Calendar management',
		'index.tytul_strony' => 'Calendar management',
		'index.zapisz_etykieta' => 'Save',
		'konfiguracja.data_start_etykieta' => 'Initial data generating calendar',
		'konfiguracja.data_stop_etykieta' => 'The final date to generate calendar',
		'konfiguracja.data_suwak_start_etykieta' => 'Date display start',
		'konfiguracja.data_suwak_stop_etykieta' => 'Date display stop',
		'konfiguracja.domyslna_grupa_etykieta' => 'Select default group',
		'konfiguracja.etykieta_konfiguruj_team' => 'Configure team group',
		'konfiguracja.etykieta_select_grupa' => 'Select group : ',
		'konfiguracja.potwierdz_usun_grupe' => 'Are you sure You want delete this group ?',
		'konfiguracja.wybierzDomyslnaGrupeEtykieta' => 'Select default group',
		'menuPodreczne.brak_metod_dla_menu' => 'There is nothing to do here',
		'menu_add_event' => 'Add event',
		'parsujTeamNaglowek.niezalogowany' => 'Team not logged in',	//TODO
		'parsujTeamNaglowek.zalogowany' => 'Team logged in',
		'pobierzTeamy.brak_grupy_w_konfiguracji' => 'The selected group does not exist',
		'przeniesEvent.blad_zapisu_danych' => 'Could not move events',
		'przeniesEvent.event_nie_istnieje' => 'Event does not exist',
		'sortujTeamWidok.listaTeamowUsunietychNaglowek' => 'Other teams',
		'sortujTeamWidok.listaTwoichTeamowNaglowek' => 'List your teams',
		'uruchomEvent.blad_uruchamiania' => '[ETYKIETA:uruchomEvent.blad_uruchamiania]',	//TODO
		'ustawLidera.blad_zapisu' => 'Error saving data',
		'ustawLidera.team_nie_istnieje' => 'Team does not exist',
		'usunGrupe.blad_zapisu' => 'Failed to remove group',
		'usunGrupe.grupa_nie_istnieje' => 'Group does not exist',
		'usunGrupe.usuwasz_grupe_domyslna_komunikat' => 'You are delete a group which is set as the default, set a new default group.',
		'usunPracownikaZEkipy.blad_podczas_wylogowanie_pracownika' => 'There is some problem with logout this worker',
		'usunPracownikaZEkipy.pracownik_zalogowany' => 'This worker is logged on to another task, are you sure  you want to move this workr ?',
		'usunPracownikaZEkipy.team_nie_istnieje' => 'Selected team does not exist',
		'usunPracownikaZEkipy.uzytkownik_nie_istnieje' => 'The selected worker was not found in the database',
		'usunPrzypisanie.blad_usuwania' => 'There is some problem with delete worker',
		'usunPrzypomnienie.bladZapisu' => '[ETYKIETA:usunPrzypomnienie.bladZapisu]',	//TODO
		'usunTeamZListy.blad_zapisu' => 'Failed to remove team from list',
		...
		'zapiszKomentarz.bladZapisu' => 'System can not save comment',
		...
		'zapiszSortowanie.blad_zapisu' => 'There were errors while sorting teams',
		'zapiszSortowanieTeamu.blad_zapisu' => '[ETYKIETA:zapiszSortowanieTeamu.blad_zapisu]',	//TODO
		'zapiszWydarzenie.komunikat_uruchom_event' => 'Added event should be running now. Do You want to start this event now? List of events to run: ',
		'zmianyWTeamie.nowy_team_nie_istnieje' => '[ETYKIETA:zmianyWTeamie.nowy_team_nie_istnieje]',	//TODO
		'zmianyWTeamie.potwierdz_wyloguj_pracownika_z_zadania' => 'Worker {USER_NAME} is currently logged in to the order {ORDER_NAME}. Transfer worker will log out him from order.',
		'zmianyWTeamie.potwierdz_wyloguj_team_z_zadania' => 'Worker {USER_NAME} which you are move is the leader of the team {OLD_TEAM_NAME} and logged in to the order {ORDER_NAME}. This will log out the whole team {OLD_TEAM_NAME} from order.',
		...
		'zmianyWTeamie.uzytkownik_zostanie_zalogowany_do_zadnia' => '{USER_NAME} will be assigned to {NEW_TEAM_NAME} and logged in to the {ORDER_NAME}',
		...
		'zmienKolor.blad_zapisu' => 'The color change was not successful.',
