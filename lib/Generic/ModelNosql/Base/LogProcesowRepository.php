...
/**
 * Base class of repository of Generic\ModelNosql\LogProcesow document.
 */
abstract class LogProcesowRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Generic\ModelNosql\LogProcesow';
        $this->isFile = false;
        $this->collectionName = 'modelnosql_logprocesow';
