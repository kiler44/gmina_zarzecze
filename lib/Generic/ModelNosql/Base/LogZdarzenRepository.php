...
/**
 * Base class of repository of Generic\ModelNosql\LogZdarzen document.
 */
abstract class LogZdarzenRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Generic\ModelNosql\LogZdarzen';
        $this->isFile = false;
        $this->collectionName = 'modelnosql_logzdarzen';
