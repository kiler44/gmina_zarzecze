...
/**
 * Base class of repository of Generic\ModelNosql\UzytkownikWersja document.
 */
abstract class UzytkownikWersjaRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Generic\ModelNosql\UzytkownikWersja';
        $this->isFile = false;
        $this->collectionName = 'modelnosql_uzytkownikwersja';
