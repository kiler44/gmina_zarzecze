...
class Mapper extends Biblioteka\Mapper\Baza
{
	...
	* @var string
	*/
	protected $zwracanyObiekt = 'Generic\Model\StawkaUzytkownika\Obiekt';
	...
	* @var string
	*/
	protected $tabela = 'modul_stawka_uzytkownika';
	...
	*/
	...
	/**
	* Zwraca ilość w tabeli modul_stawka_uzytkownika.
	* @return int
	*/
	...
	public function pobierzDlaUzytkownika($idUzytkownika)
	{
		$sql = 'SELECT * FROM ' . $this->tabela
			. ' WHERE id_projektu = ' . ID_PROJEKTU
			. ' AND id_uzytkownika = '.$idUzytkownika
			. ' ORDER BY data_start';
		
		return $this->pobierzWiele($sql);
	}
	
	public function sprawdzCzyDataWolna($dataStart, $idUzytkownika)
	{
		$sql = 'SELECT * FROM ' . $this->tabela
			. ' WHERE id_projektu = ' . ID_PROJEKTU
			. ' AND id_uzytkownika = '.$idUzytkownika
		   . ' AND (data_start >= \''.$dataStart.'\' AND \''.$dataStart.'\' <= data_stop)'
			. ' ORDER BY data_start';
	...
	/**
	* Zwraca dla podanego id w tabeli modul_stawka_uzytkownika.
	* @return \Generic\Model\Generic\Model\StawkaUzytkownika\Obiekt\Obiekt
	*/
	...
	/**
	* Zwraca wszystko z tabeli modul_stawka_uzytkownika.
	* @return Array
	*/
	...
	/**
	* Wyszukuje w tabeli modul_stawka_uzytkownika dla podanych kryteriów.
	* @return Array
	*/
	...
	/**
	* Zwraca ilość pasujących elementów dla podanych kryteriów w tabeli modul_stawka_uzytkownika.
	* @return int
	*/
