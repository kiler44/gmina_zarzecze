<?php
namespace Generic\Konfiguracja\Modul\BlokMenu;

use Generic\Konfiguracja\Konfiguracja;

/**
 * @property int $k['kategoria_startowa']
 * @property bool $k['linki_seo_nowe']
...
class Http extends Konfiguracja
{
	...
	'linki_seo_nowe' => array(
		'opis' => 'Jeżeli zaznaczone, wszystkie linki będą przerabiane na linki seo ze spanem',
		'typ' => 'bool',
		'wartosc' => null,
		),
