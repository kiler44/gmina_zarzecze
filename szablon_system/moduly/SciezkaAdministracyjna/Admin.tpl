...
<div id="content-header">
	...
	<div class="btn-group">
		{{BEGIN opcja}}
		<a href="{{$url}}" class="btn btn-large tip-bottom" title="{{$etykieta}}"><i class="{{$ikona}}"></i>
			{{IF $quantity}}	<span class="label label-danger" style="margin-top: 0px; margin-left: -8px; padding: 1px 4px;">{{$quantity}}</span> {{END IF}}
		</a>
		{{END}}
	</div>
	{{END}}
