...
{{BEGIN lista}}
	<div class="widget-box">
		{{IF $raportyPdfUrl}}<a class="btn btn-primary fR margin" href="{{$raportyPdfUrl}}"><i class="icon icon-th-list"></i> {{$etykieta_raportyPdf}}</a>{{END IF}}
		
		{{IF $raportyExcelUrl}}<a class="btn btn-success fR margin" href="{{$raportyExcelUrl}}"><i class="icon icon-credit-card"></i> {{$etykieta_raportyExcel}}</a>{{END IF}}
