...
{{IF $iloscWynikow}}
	...
	$(document).on('click', "#pobierzNotatke", function(e){ ladujPreloader(); var idZamowienia = $(this).attr('id-attr'); ajax("{{$urlPobierzNoteatkeGET}}", potwierdzPobranoNotatke , {idZamowienia: idZamowienia}, 'POST', 'json', true ); });
