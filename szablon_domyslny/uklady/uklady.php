...
array(
	...
	'regiony' => array(
		...
		'region_1' => array('!wszystko', 'kategoria', 'BlokOpisowy'),
		'region_2' => array('!wszystko', 'kategoria', 'BlokOpisowy'),
		'region_3' => array('!wszystko', 'kategoria', 'BlokOpisowy', 'BlokMenu', 'BlokWyszukiwarka'),
		'region_4' => array('!wszystko', 'kategoria', 'BlokSciezka', 'BlokOpisowy','BlokMenu'),
		'region_5' => array('!wszystko', 'kategoria', 'BlokSciezka', 'BlokOpisowy','BlokMenu'),
	),
	'struktura' => '
<table border="0" frame="void" cellpadding="0" cellspacing="3" width="100%">
	<tr width="100%">
	...
	<tr width="100%">
		<td colspan="2" class="region" id="r_2"><ul id="region_2" style="min-height:60px;">{{$region_2}}</ul><div class="clear"></div></td>
	</tr>
	<tr width="100%">
		<td colspan="2" class="region" id="r_3"><ul id="region_3" style="min-height:60px;">{{$region_3}}</ul><div class="clear"></div></td>
	</tr>
	<tr width="100%">
		<td class="region" id="r_0" width="75%"><ul id="region_0" style="min-height:380px;">{{$region_0}}</ul><div class="clear"></div></td>
		<td class="region" id="r_4" width="25%"><ul id="region_4" style="min-height:380px;">{{$region_4}}</ul><div class="clear"></div></td>
	</tr>
	<tr width="100%">
		<td colspan="2" class="region" id="r_5"><ul id="region_5" style="min-height:140px;">{{$region_5}}</ul><div class="clear"></div></td>
	</tr>
...
'),
	array(
		'kod' => 'uklad_dwie_kolumny_szersze_menu',
		'nazwa' => 'Dwie kolumny szersze menu',
		'plik' => 'uklad_dwie_kolumny_szersze_menu.tpl',
		'regiony' => array(
